...
namespace Ravenfield.Trigger
{
    ...
    public partial class TriggerOnActorEnterVehicle : TriggerBaseComponent
    {
		...
		[SignalDoc("Sent when an actor entered the vehicle", actor ="The entering actor", contextSource = SignalDocAttribute.ContextSource.Actor)]
		public TriggerSend onActorEntered;

		[SignalDoc("Sent when an actor exits the vehicle", actor = "The exiting actor", contextSource = SignalDocAttribute.ContextSource.Actor)]
