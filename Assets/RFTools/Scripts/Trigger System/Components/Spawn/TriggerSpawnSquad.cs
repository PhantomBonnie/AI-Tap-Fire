...
namespace Ravenfield.Trigger
{
	...
	public partial class TriggerSpawnSquad : TriggerReceiver
	{
		...
		[InspectorName("Automatic Respawn")] public RespawnType respawnType = RespawnType.Never;
		...
		[SignalDoc("Sent when a squad spawned by this component is alerted", squad = "The alerted squad", contextSource = SignalDocAttribute.ContextSource.Squad)]
