...
namespace Ravenfield.Trigger
{
    ...
    public partial class TriggerDetectionGroup : TriggerBaseComponent
    {
        ...
        [SignalDoc("Sent when this group is is alerted by a member squad", squad = "The squad that detected the enemy", contextSource = SignalDocAttribute.ContextSource.Squad)]
