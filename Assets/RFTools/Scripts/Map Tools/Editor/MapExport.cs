...
public class MapExport {
	...
	public static bool BuildBundle(BuildTarget buildTarget, out string filepath, bool ignoreGraphCacheWarning) {
		...
		var result = BuildBundleInternal(buildTarget, out filepath, ignoreGraphCacheWarning);
		onAfterMapExport?.Invoke();

		return result;
	}

	static bool BuildBundleInternal(BuildTarget buildTarget, out string filepath, bool ignoreGraphCacheWarning) {
		filepath = "";
